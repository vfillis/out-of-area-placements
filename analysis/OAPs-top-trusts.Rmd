...
### Top 10 of October 2020

Look at the top 10 trusts with most inappropriate OAP days in October 2020. 

```{r}
OAPs.trusts.days.oct20 <- arrange(OAPs.trusts.days.oct20, desc(value))

#Which ones are the top 10?
OAPs.trusts.days.oct20.top10 <- head(OAPs.trusts.days.oct20, 11)
```

### Export

```{r}
write.csv(OAPs.trusts.days.oct20.top10, file = "OAPs_trusts_days_top10oct20.csv")
```
...
#Which ones are the top 10?
OAPs.trusts.costs.oct20.top10 <- head(OAPs.trusts.costs.oct20, 11)
```

### Export

```{r}
write.csv(OAPs.trusts.costs.oct20.top10, file = "OAPs_trusts_costs_top10oct20.csv")
```
